...
export default function TestimonialSection() {
    ...
    const CreateCard = ({ card }: { card: CardProps }) => (
        <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0">
            ...
            <p className="text-sm py-4 text-gray-800">CodInspect works silently in the background. It's like having a senior engineer on the team who handles the execution while I focus on design.</p>
        </div>
    );
    ...
    return (
        <>
            <SectionTitle
                ...
                description="Hear how senior developers and product founders are scaling their output with CodInspect."
            />
